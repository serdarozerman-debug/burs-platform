...
-- STEP 1: Organizations ekle (TÜM gerekli kolonlarla)
INSERT INTO organizations (
  ...
  ('Vehbi Koç Vakfı', 'vehbi-koc-vakfi', 'vakıf', 'https://www.vkv.org.tr', 'https://www.vkv.org.tr/Content/images/logo.png', 'Eğitim ve kültür alanında faaliyet gösteren vakıf', true),
  ('İstanbul Büyükşehir Belediyesi', 'istanbul-buyuksehir-belediyesi', 'belediye', 'https://www.ibb.istanbul', 'https://www.ibb.istanbul/images/logo.svg', 'İstanbul Büyükşehir Belediyesi', true),
  ('TÜBİTAK', 'tubitak', 'kamu', 'https://www.tubitak.gov.tr', 'https://www.tubitak.gov.tr/sites/default/files/tubitak_logo.png', 'Türkiye Bilimsel ve Teknolojik Araştırma Kurumu', true),
  ('Türk Eğitim Vakfı', 'turk-egitim-vakfi', 'vakıf', 'https://www.tev.org.tr', 'https://www.tev.org.tr/images/tev-logo.png', 'Türkiye''nin en köklü eğitim vakıflarından', true),
  ('Sabancı Vakfı', 'sabanci-vakfi', 'vakıf', 'https://www.sabancivakfi.org', 'https://www.sabancivakfi.org/Content/images/logo.svg', 'Eğitim ve sosyal kalkınmada öncü vakıf', true),
  ('Koç Üniversitesi', 'koc-universitesi', 'üniversite', 'https://www.ku.edu.tr', 'https://www.ku.edu.tr/images/ku-logo.png', 'Türkiye''nin önde gelen özel üniversitelerinden', true),
  ('Anadolu Üniversitesi', 'anadolu-universitesi', 'üniversite', 'https://www.anadolu.edu.tr', 'https://www.anadolu.edu.tr/images/logo.png', 'Türkiye''nin en büyük üniversitelerinden', true),
  ('Darüşşafaka', 'darussafaka', 'vakıf', 'https://www.darussafaka.org', 'https://www.darussafaka.org/images/logo.png', 'Yetim ve öksüz öğrencilere eğitim desteği', true),
  ('Boğaziçi Üniversitesi', 'bogazici-universitesi', 'üniversite', 'https://www.boun.edu.tr', 'https://www.boun.edu.tr/images/logo.png', 'Türkiye''nin en prestijli üniversitelerinden', true),
  ('Engelsiz Eğitim Vakfı', 'engelsiz-egitim-vakfi', 'dernek', 'https://www.engelsizvakif.org', 'https://www.engelsizvakif.org/images/logo.png', 'Engelli öğrencilere eğitim desteği', true);
...
FROM (VALUES
  ...
  ('Darüşşafaka', 'Darüşşafaka Tam Burs Programı', 'darussafaka-tam-burs', 'Yetim ve öksüz öğrencilere tam burs. Barınma, iaşe ve eğitim masrafları karşılanır.', 10000, 'tek seferlik', 'lise', 'ihtiyaç', '2024-11-01', 'https://www.darussafaka.org'),
