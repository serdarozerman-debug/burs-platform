"""
Supabase Management API ile SQL çalıştırmak için
...
# Not: Supabase Management API direkt SQL çalıştırmayı desteklemiyor
# Sadece migration'lar için kullanılıyor

# En iyi çözüm: Supabase Dashboard → SQL Editor kullanın
print("⚠️  Supabase Management API direkt SQL çalıştırmayı desteklemiyor.")
...
print("\n✅ SQL çalıştırdıktan sonra scraper'ı tekrar çalıştırabilirsiniz")
